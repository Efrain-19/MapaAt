...
function exp_Atropellos_Concepcin_3rule0_eval_expression(context) {
    // Fallecidos > 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Fallecidos')  > 0);
    } else {
        return (feature.get('Fallecidos')  > 0);
    }
}
...
function exp_Atropellos_Concepcin_3rule1_eval_expression(context) {
    // Graves > 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Graves')  > 0);
    } else {
        return (feature.get('Graves')  > 0);
    }
}
...
function exp_Atropellos_Concepcin_3rule2_eval_expression(context) {
    // Menos_Grav > 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Menos_Grav')  > 0);
    } else {
        return (feature.get('Menos_Grav')  > 0);
    }
}
...
function exp_Atropellos_Concepcin_3rule3_eval_expression(context) {
    // Leves > 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Leves')  > 0);
    } else {
        return (feature.get('Leves')  > 0);
    }
}
...
function exp_Atropellos_Concepcin_3rule4_eval_expression(context) {
    // Ilesos > 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Ilesos')  > 0);
    } else {
        return (feature.get('Ilesos')  > 0);
    }
}